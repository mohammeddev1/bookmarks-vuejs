  ...
  <div class="max-w-lg p-6 rounded-3xl w-full bg-indigo-200">
    <form @submit.prevent class="space-y-4 relative flex flex-col justify-center">
      ...
      <button
        type="button"
        @click="add()"
        class="text-white w-60 mx-auto bg-blue-600 hover:bg-blue-800 cursor-pointer box-border border border-transparent shadow-xs font-medium leading-5 rounded-lg text-xs px-3 py-1.5 focus:outline-none"
      >
        Add website
      </button>
    </form>
